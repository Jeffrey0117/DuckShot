...
<p align="center">
  <a href="https://github.com/Jeffrey0117/DuckShot/releases/latest/download/DuckShot-Setup-1.0.2.exe"><b>⬇️ 下載 Windows 安裝檔</b></a> ·
...
到 [Releases](https://github.com/Jeffrey0117/DuckShot/releases/latest) 下載 `DuckShot-Setup-1.0.2.exe` 執行即可。Windows 10 / 11（x64）。
